...
class DemoAnimateCss extends Component {
    constructor(props) {
        super(props);
            ...
            <div className="Animate-CSS">
                <div className="row">
                    <div className="col-lg-3 col-md-6 col-sm-12 box">
                         <div className="animated duration-1000 bouceIn infinite">
                              bouceIn 1.0s
                         </div>
                    </div>
                    <div className="col-lg-3 col-md-6 col-sm-12 box">
                         <div className="animated duration-2500 bouceIn infinite">
                              bouceIn 2.5s
                         </div>
                    </div>
                    <div className="col-lg-3 col-md-6 col-sm-12 box">
                         <div className="animated duration-2900 bouceIn infinite">
                              bouceIn 2.9s
                         </div>
                    </div>
                </div>
